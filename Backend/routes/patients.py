...
async def add_patient(patient: dict):
    ...
    try:
        ...
        chest_pain = bool(patient.get("chest_pain", 0))
        shortness_of_breath = bool(patient.get("shortness_of_breath", 0))
        fever = bool(patient.get("fever", 0))
        cough = bool(patient.get("cough", 0))
        fatigue = bool(patient.get("fatigue", 0))
        dizziness = bool(patient.get("dizziness", 0))
        nausea = bool(patient.get("nausea", 0))
        confusion = bool(patient.get("confusion", 0))
        abdominal_pain = bool(patient.get("abdominal_pain", 0))
        headache = bool(patient.get("headache", 0))
